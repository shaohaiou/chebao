...
namespace Chebao.Components
{
    public class ChebaoContext
    {
        ...
        private static ChebaoContext _context = null;
        ...
        private ChebaoContext()
        {
        }

        private ChebaoContext(HttpContext context)
        {
            try
            {
        ...
        [JsonIgnore]
        public static ChebaoContext Current
        {
            get
            {
                if (HttpContext.Current == null)
                {
                    if (_context == null)
                    {
                        _context = new ChebaoContext();
                    }
                    return _context;
                }
                HttpContext httpContext = HttpContext.Current;
                ChebaoContext context = null;
                context = httpContext.Items[GlobalKey.CONTEXT_KEY] as ChebaoContext;
                if (context == null)
                {
                    context = new ChebaoContext(httpContext);
        ...
        private static void SaveContextToStore(ChebaoContext context)
        {
        ...
        private static string jsversion = string.Empty;
        public string Jsversion 
        {
            get
            {
                ...
                {
                    jsversion = DateTime.Now.ToString("yyyyMMddHHmmss");
                }
                return jsversion;
            }
        }

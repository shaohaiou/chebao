                    ...
                    <asp:Repeater runat="server" ID="rptSubAccount">
                        <HeaderTemplate>
                            <div class="usermg-th-line clearfix">
                                <span class="w80">用户名/密码</span> <span class="w60">联系人</span>
                                <span class="w100" style="text-align:left!important;">联系方式</span> <span class="w200" style="text-align:left!important;">联系地址</span>
                                <span class="w60">邮政编码</span> <span class="w60">有效期至</span>
                                <span class="w60">溢价比例</span> <span class="w80">尺寸查询</span>
                                <span class="w120">最后登录时间</span><span class="w60">操作</span>
                            </div>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <div class="usermg-tc-line clearfix">
                                <span class="w80">
                                    ...
                                    <%#Eval("PasswordText")%></span> <span class="w60">
                                        <%# string.IsNullOrEmpty(Eval("LinkName").ToString()) ? "&nbsp;" : Eval("LinkName").ToString()%></span> <span class="w100" style="text-align:left!important;">手机：<%#Eval("Mobile")%><br />
                                            电话：<%#Eval("TelPhone")%></span> <span class="w200" style="text-align:left!important;">
                                                <%#Eval("Province")%>
                                                <%#Eval("City")%>
                                                <%#Eval("District")%><br />
                                                <%#Eval("Address")%></span> <span class="w60">
                                                    <%#Eval("PostCode")%></span> <span class="w60">

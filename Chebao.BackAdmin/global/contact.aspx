<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="Chebao.BackAdmin.global.contact" %>
...
<body>
    <uc1:header ID="header1" runat="server" CurrentTag="联系我们" />
    <div id="main">
        <div style="padding: 20px;">
            <%=Sitesetting == null ? string.Empty : Sitesetting.Contact%></div>
    </div>
    <div class="footer">
        <div class="footmain">

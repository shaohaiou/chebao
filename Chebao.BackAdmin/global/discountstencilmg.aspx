<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="discountstencilmg.aspx.cs" Inherits="Chebao.BackAdmin.global.discountstencilmg" %>
            ...
            <asp:Repeater ID="rptData" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <a href="discountstenciledit.aspx?id=<%#Eval("ID") %>&from=<%=UrlEncode(CurrentUrl) %>" class="pl10" val="<%#Eval("ID") %>">设置</a>
                            <a href="javascript:void(0);" class="btnDel pl10 red" val="<%#Eval("ID") %>">删除</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
